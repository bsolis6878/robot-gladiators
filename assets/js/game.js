...
// loops robot name prompt if nothing is entered
...
var fightOrSkip = function() {
    ...
    if (promptFight === "skip") {
        ...
        if (confirmSkip) {
            window.alert(playerInfo.name + " has decided to skip this fight. On to the next round!");
...
var endGame = function() {
    ...
    if (playerInfo.health > 0) {
        window.alert("Great job, you've survived the game! You now have " + playerInfo.money + " dollars.");
    }
    else {
